...
public final class CobKey extends Module implements TickListener {
    ...
    public CobKey() {
        super(
                EncryptedString.of("Cobweb Key"),
                EncryptedString.of("Optimizes your webbing speed and precision"),
                -1,
                Category.sword
        );
                ...
                if (mc.crosshairTarget instanceof BlockHitResult blockHit) {
                    ...
                    if (!blockState.isAir()) {
                        ActionResult result = mc.interactionManager.interactBlock(
                                mc.player, Hand.MAIN_HAND, blockHit
                        );
