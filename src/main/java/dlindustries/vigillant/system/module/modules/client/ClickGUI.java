...
public final class ClickGUI extends Module implements PacketReceiveListener {
	public static final NumberSetting red = new NumberSetting(EncryptedString.of("Red"), 0, 255, 185, 1);
	public static final NumberSetting green = new NumberSetting(EncryptedString.of("Green"), 0, 255, 0, 1);
	public static final NumberSetting blue = new NumberSetting(EncryptedString.of("Blue"), 0, 255, 95, 1);
	public enum Theme {
		DEFAULT("Default"),
		CRIMSON("Crimson"),
		CUTE("Cute"),
	...
	public void onEnable() {
		...
		if (system.INSTANCE.clickGui != null) {
			mc.execute(() -> mc.setScreen(system.INSTANCE.clickGui));
