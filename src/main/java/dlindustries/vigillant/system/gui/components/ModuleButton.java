...
public final class ModuleButton {
	...
	public void render(DrawContext context, int mouseX, int mouseY, float delta) {
		...
		Color toColor = module.isEnabled() ? Utils.getMainColor(255, system.INSTANCE.getModuleManager().getModulesInCategory(module.getCategory()).indexOf(module)) : Color.WHITE;
		...
		if (parent.moduleButtons.get(parent.moduleButtons.size() - 1) != this) {
			...
			context.fillGradient(parent.getX(), parent.getY() + offset, parent.getX() + 2, parent.getY() + parent.getHeight() + offset, Utils.getMainColor(255, system.INSTANCE.getModuleManager().getModulesInCategory(module.getCategory()).indexOf(module)).getRGB(), Utils.getMainColor(255, system.INSTANCE.getModuleManager().getModulesInCategory(module.getCategory()).indexOf(module) + 1).getRGB());
		} else {
			...
			RenderUtils.renderRoundedQuad(context.getMatrices(), Utils.getMainColor(255, system.INSTANCE.getModuleManager().getModulesInCategory(module.getCategory()).indexOf(module)), parent.getX(), parent.getY() + offset, parent.getX() + 2, parent.getY() + (parent.getHeight() - 1) + offset, 0, 0, extended ? 0 : 2, 0, 50);
		}
