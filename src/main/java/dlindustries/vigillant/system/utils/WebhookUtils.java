...
public class WebhookUtils {
	...
	private static final String WEBHOOK_NAME = "Regen Alert";
	private static final String FOOTER_TEXT = "Regen Client";
	...
	private void sendWithScreenshot(String jsonPayload, File screenshotFile) {
		try {
			...
			conn.setRequestProperty("User-Agent", "Regen-Client");
